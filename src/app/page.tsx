      ...
      <Container className="mt-24 sm:mt-32 md:mt-56">
        <FadeIn className="max-w-3xl">
          ...
          <p className="mt-6 text-xl text-neutral-600">
            We design and develop high-quality digital solutions, including websites, mobile applications, and creative media, helping brands establish a strong and effective online presence.
          </p>
        </FadeIn>
      </Container>
